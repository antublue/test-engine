...
public class PlatformThreadsExecutionContextExecutor implements ExecutionContextExecutor {

    private static final Logger LOGGER =
            LoggerFactory.getLogger(PlatformThreadsExecutionContextExecutor.class);
    ...
    /** Constructor */
    public PlatformThreadsExecutionContextExecutor() {
