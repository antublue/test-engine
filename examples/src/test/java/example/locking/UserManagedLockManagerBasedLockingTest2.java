...
/** Example test */
public class UserManagedLockManagerBasedLockingTest2 {
    ...
    public void lockingTest() throws Throwable {
        ...
        try {
            reentrantReadWriteLock = context.getLockManager(NAMESPACE).getLock(LOCK_NAME);
        ...
        context.getLockManager()
                .executeInWriteLock(
                        "TEST",
                        () -> {
                            System.out.println("sleeping UserManagedLockManagerBasedLockingTest2");
                            Thread.sleep(10000);
                            System.out.println(
                                    "continuing UserManagedLockManagerBasedLockingTest2");
                        });
    }
