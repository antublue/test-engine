...
public class JUnit5LikeTest3Extension implements Extension {
    ...
    public void postInstantiateCallback(Object testInstance) {
        ...
        ((JUnit5LikeTest3) testInstance).ACTUAL.add("extension.postInstantiateMethodsCallback()");
    }
    ...
    public void prePrepareMethodsCallback(Object testInstance) {
        System.out.println(
                String.format(
                        ...
                        this.getClass().getSimpleName(), testInstance.getClass().getName()));
        ((JUnit5LikeTest3) testInstance).ACTUAL.add("extension.prePrepareMethodsCallback()");
    }
    ...
    public void postPrepareMethodsCallback(Object testInstance) {
        System.out.println(
                String.format(
                        ...
                        this.getClass().getSimpleName(), testInstance.getClass().getName()));
        ((JUnit5LikeTest3) testInstance).ACTUAL.add("extension.postPrepareMethodsCallback()");
    }
    ...
    public void preBeforeEachMethodsCallback(Object testInstance, Argument testArgument) {
        System.out.println(
                String.format(
                        ...
                        this.getClass().getSimpleName(), testInstance.getClass().getName()));
        ((JUnit5LikeTest3) testInstance).ACTUAL.add("extension.preBeforeEachMethodsCallback()");
    }
    ...
    public void postBeforeEachMethodsCallback(Object testInstance, Argument testArgument) {
        System.out.println(
                String.format(
                        ...
                        this.getClass().getSimpleName(), testInstance.getClass().getName()));
        ((JUnit5LikeTest3) testInstance).ACTUAL.add("extension.postBeforeEachMethodsCallback()");
    }
    ...
    public void preTestMethodsCallback(Method method, Object testInstance, Argument testArgument) {
        System.out.println(
                String.format(
                        ...
                        this.getClass().getSimpleName(), testInstance.getClass().getName()));
        ((JUnit5LikeTest3) testInstance).ACTUAL.add("extension.preTestMethodsCallback()");
    }
    ...
    public void postTestMethodsCallback(Method method, Object testInstance, Argument testArgument) {
        System.out.println(
                String.format(
                        ...
                        this.getClass().getSimpleName(), testInstance.getClass().getName()));
        ((JUnit5LikeTest3) testInstance).ACTUAL.add("extension.postTestMethodsCallback()");
    }
    ...
    public void preAfterEachMethodsCallback(Object testInstance, Argument testArgument) {
        System.out.println(
                String.format(
                        ...
                        this.getClass().getSimpleName(), testInstance.getClass().getName()));
        ((JUnit5LikeTest3) testInstance).ACTUAL.add("extension.preAfterEachMethodsCallback()");
    }
    ...
    public void postAfterEachMethodsCallback(Object testInstance, Argument testArgument) {
        System.out.println(
                String.format(
                        ...
                        this.getClass().getSimpleName(), testInstance.getClass().getName()));
        ((JUnit5LikeTest3) testInstance).ACTUAL.add("extension.postAfterEachMethodsCallback()");
    }
    ...
    public void preConcludeMethodsCallback(Object testInstance) {
        System.out.println(
                String.format(
                        ...
                        this.getClass().getSimpleName(), testInstance.getClass().getName()));
        List<String> ACTUAL = ((JUnit5LikeTest3) testInstance).ACTUAL;
    ...
    public void postConcludeMethodsCallback(Object testInstance) {
        ...
        for (String string : ACTUAL) {
            StandardStreams.println("%s", string);
        }
    }
}
