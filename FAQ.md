...
You could use the test engine in place of Junit 5 for some test scenarios, but that's not the project goal.
...
The test engine does have a global test engine extension model to execute code before and after test execution, but currently, there is no test extension Extension model/paradigm.
